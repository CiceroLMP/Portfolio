...
const cvButton = document.getElementById("cvButton");
  ...
  cvButton.addEventListener("click", () => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          cvButton.innerHTML = `Download my CV <img src="assets/Arrow right.png" alt="">`;
          cvButton.classList.remove("fade-out");
          cvButton.classList.add("fade-in");
        }, 400);
      }, 3000);
  ...
  function copyEmail2() {
    ...
    let emailCopied = document.getElementById("copied");
    emailCopied.classList.add("show");
    emailCopied.textContent = "E-mail copied!";
    setTimeout(() => emailCopied.classList.remove("show"), 2000);
  }
  ...
  const generalSkills = [
    { img: "assets/english.png", name: "English Proficiency" },
    { img: "assets/adaptability.png", name: "Adaptability" },
    { img: "assets/communication.png", name: "Communication" },
    { img: "assets/fastTyping.png", name: "Fast Typing" },
    { img: "assets/flexibility.png", name: "Flexibility" },
  ];
...
event.preventDefault()
  ...
  .catch((error) =>{
    ...
    console.error("There was an error sending your email!", error);
  })


  .finally(() => {
    submitBtn.textContent = "S E N D"
